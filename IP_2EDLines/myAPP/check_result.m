...
is_plot = 1; is_output = 1;
FLAG_VALID = 0; 

row = 29;
% output_data1 = left_border_0; % output_data1 works like a buffer
output = output_data1;  %%%
...
imgOutputPath = [imgOutputPath, '/', date_folder];  mkdir([imgOutputPath, filesep, folderName]);
