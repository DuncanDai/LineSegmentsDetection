...
global flag_quit; index_limit = 200;  % should be divided by 100
%% run function
...
%% plot and output
% during analysing the output_data: stop to plot and save the image
%%% Plot
% imshow(img, 'border', 'tight', 'initialmagnification', 100);  % image is uint8 grayscale
% hold on
