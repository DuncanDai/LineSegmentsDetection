function [number, length, window_pos] = extract_window_features(full_edges_filter_by_angle, scale, windowStart, windowEnd)
...
valid_inds = filter_by_window(full_edges_filter_by_angle, scale, windowStart, windowEnd);
valid_edges_full = full_edges_filter_by_angle(valid_inds, :);

[number, length] = calc_edges_number_and_length(valid_edges_full);
