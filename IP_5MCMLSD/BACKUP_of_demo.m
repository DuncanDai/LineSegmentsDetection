...
%%
MIN_LINE_NUMBER = 15; % used as hyperparameter to select the edgeLine -> enough to detect the borders.
...
t1 = toc(ticId1);
disp(['Running time in PHT/LSD = ', num2str(t1), ' second(s)/n']);
...
t2 = toc(ticId2);
disp(['Running time in MCM = ', num2str(t2), ' second(s)/n']);
