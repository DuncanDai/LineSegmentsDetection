...
[runTime_PHT, runTime_MCM, edgeLines] = mex_edgeDetecter(img)
%%
MIN_LINE_NUMBER = 15;
linesNumber = size(edgeLines, 1);
selectedLineNumber = min(MIN_LINE_NUMBER, linesNumber);
edgeLines = edgeLines(1:selectedLineNumber, 1:4);
